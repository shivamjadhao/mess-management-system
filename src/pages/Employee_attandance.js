...
function Employee_attandance() {
  ...
  useEffect(() => {
    ...
    axios
      .get(base_url + `/present_on?${mess_id ? "mess_id=" + mess_id : ""}`)
      .then((response) => {
        response.data[0] != undefined
          ? setData((prev) => ({
              title: mess_id ? `Employee attandance` : `Employee attandance`,
...
export default Employee_attandance;
